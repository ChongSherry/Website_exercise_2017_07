...
import Modal_add from './Singlepage/mod_Singlepage_add';
import Modal_edit from './Singlepage/mod_Singlepage_edit';
...
class Singlepage extends Component {
    ...
    handler_getList() {
        ...
        ajax.get(
            ajax.url(ajax.ports.Singlepage.list)
        ).then((xhr) => {
    ...
    handler_remove(id) {
        let doRemove = () => {
            ...
            this.setState({ loading: true });
            ajax.post(
                ajax.url(ajax.ports.Singlepage.remove),
                { "ids": ids }
            ).then(() => {
                this.handler_getList();
            }).catch((msg) => {
...
export default connect(state => ({ state: state.get("view") }))(Singlepage)