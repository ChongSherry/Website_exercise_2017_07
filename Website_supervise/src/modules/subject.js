...
import Mod_class_add from './subject/mod_subject_add';
import Mod_class_edit from './subject/mod_subject_edit';
...
export default connect(state => ({ state: state.get("view") }))(Subject)